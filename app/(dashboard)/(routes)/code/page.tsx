...
type ExtendedChatCompletionRequestMessage = Omit<OpenAI.Chat.ChatCompletionMessage, 'role'> & { role: "user" | "assistant" };
    ...
    return (
        <div>
            <Heading
                ...
                description="Our most advanced coding chat model."
                icon={Code}
